...
SECRET_KEY = '3d1duyl1eze$xp*(-!)87(%2n=z0q@96hbq!ubw9j9glub81w!'
...
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.db.DatabaseCache',#指定缓存类型 数据库缓存
        'LOCATION': 'my_cache_table',#指定缓存的表名
    }
}
#上传文件路径
